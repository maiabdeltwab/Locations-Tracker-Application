...
public class RolePanel extends javax.swing.JPanel
{
    ...
    try
      {
        ...
        viewonly(RolePanel.user);

        business = new BaoFactory().createRoleBao(user);
        RoleDao dao = new DaoFactory().createRoleDao(user);
        initComponents();
  ...
  private void setTableModel(List<RoleDto> roles)
  {
    ...
    roleTable.setModel(new javax.swing.table.DefaultTableModel(roleTableArr,
  ...
  private void initComponents()//GEN-BEGIN:initComponents
  {
    ...
    roleTable.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
        ...
        if(reply==JOptionPane.YES_OPTION)
          {
            ...
            if(business.delete(role))
              ...
              {
                JOptionPane.showMessageDialog(null, "Can't delete object!",
                  "Error", 0);
              }
          }
      }
        ...
        if(checkValidity())
          {
            ...
            if(business.update(role, user))
              ...
              {
                JOptionPane.showMessageDialog(null, "Role does'nt exist!",
                  "Error", 0);
              }
          }
