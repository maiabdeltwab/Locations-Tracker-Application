...
public class LogInFrame extends javax.swing.JFrame
{
  ...
  static private void keeplogin()
  {
    ...
    UserBao user_bao =
      new BaoFactory().createUserBao(user); //create bao object

    user =
      user_bao.Keeplogin(); //check for if previous user keeped his login through keeplogin bao method
  ...
  public void logout(UserDto user)
  {
    ...
    UserBao user_bao =
      new BaoFactory().createUserBao(user); //user bao object
        ...
        if(user_result!=null)
          {
            ...
            MainFrame main_frame = new MainFrame(user_result);
  ...
  private void initComponents()//GEN-BEGIN:initComponents
  {
    ...
    jPanel2.setBackground(new java.awt.Color(0, 49, 234));
    ...
    jPanel2.add(logInButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 130, 48));

    login_panel.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 400, 130, 50));
  ...
  private void logInButton1MouseMoved(java.awt.event.MouseEvent evt)//GEN-FIRST:event_logInButton1MouseMoved
  {//GEN-HEADEREND:event_logInButton1MouseMoved
    // TODO add your handling code here:
    jPanel2.setBackground(Color.decode("#0037C4"));
  }//GEN-LAST:event_logInButton1MouseMoved

  private void logInButton1MouseExited(java.awt.event.MouseEvent evt)//GEN-FIRST:event_logInButton1MouseExited
  {//GEN-HEADEREND:event_logInButton1MouseExited
    // TODO add your handling code here:
    
    jPanel2.setBackground(Color.decode("#0031EA"));
    ...
    java.awt.EventQueue.invokeLater(new Runnable()
    {
      public void run()
      {
        ...
        if(run==true||user==null) //if not run will be true and login frame will open
          ...
          {
            MainFrame main_frame = new MainFrame(user);
