...
public class EquipmentTypePanel extends javax.swing.JPanel
{
  ...
  public EquipmentTypePanel(UserDto user)
  {
    try
      {
        business = new BaoFactory().createEquipmentTypeBao(user);
        EquipmentTypeDao dao =
          new DaoFactory().createEquipmentTypeDao(user);
        initComponents();
        EquipmentTypePanel.user = user;
        viewonly(EquipmentTypePanel.user);
  ...
  private void setTableModel(List<EquipmentTypeDto> equipt)
  {
    ...
    EqTypeTable.setModel(new javax.swing.table.DefaultTableModel(equipsArr,
        new String[] { "Id", "Code", "Name", "No. Of Equipments" }));
  ...
  private void initComponents()//GEN-BEGIN:initComponents
  {
    ...
    EqTypeTable.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    noOfEquipText.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    if(searchTextField.getText().equalsIgnoreCase("Enter text to search"))
      {
        ...
        searchTextField.setBorder(new LineBorder(Color.decode("#0081D3"),
            2));
    ...
    try
      {
        ...
        EquipmentTypeDao e = new DaoFactory().createEquipmentTypeDao(user);
    ...
    try
      {
        ...
        et.setId(Integer.parseInt(EqTypeTable.getModel().getValueAt(row,
          0).toString()));
        et.setCode(EqTypeTable.getModel().getValueAt(row, 1).toString());
        et.setName(EqTypeTable.getModel().getValueAt(row, 2).toString());
        et.setNo_of_equip(Integer.parseInt(EqTypeTable.getModel().getValueAt(row,
          3).toString()));
  ...
  private void setNewTable(List<EquipmentDto> eq)
  {
    ...
    EqTypeTable.setModel(new javax.swing.table.DefaultTableModel(eqArr,
        new String[] { "Id", "Code", "Type ID", "Country" }));
  }
  ...
  private void setSpecTable(List<EquipSpecificationDto> eq_spec)
  {
    ...
    try
    ...
    catch(java.lang.ArrayIndexOutOfBoundsException e)
      {
        ...
        JOptionPane.showMessageDialog(null,
          "Please select type from table to show its equipments");
      }
    catch(Exception e)
      {
        e.printStackTrace();
    ...
    try
      {
        EqTypeSpecDao dao = new DaoFactory().createEqTypeSpecDao(user);
        ...
        if(eq_sp!=null)
        ...
        else
          {
            ...
            JOptionPane.showMessageDialog(null,
              "No Specifications Set For This Type");
            EqTypeTable.repaint();
          }
      }
    catch(java.lang.ArrayIndexOutOfBoundsException e)
      {
        ...
        JOptionPane.showMessageDialog(null,
          "Please select type from table to show its specifications");
      }
    catch(Exception e)
      {
        e.printStackTrace();
    ...
    try
      {
        ...
        EqTypeSpecPanel specs = new EqTypeSpecPanel(user);
