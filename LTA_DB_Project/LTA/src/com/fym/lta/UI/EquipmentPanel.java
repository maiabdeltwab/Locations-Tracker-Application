...
public class EquipmentPanel extends javax.swing.JPanel
{
  ...
  private void setTableModel(List<EquipmentDto> equips)
  {
    ...
    EquipmentTable.setModel(new javax.swing.table.DefaultTableModel(equipsArr,
        new String[] { "Id", "Code", "Type", "Country", "Location" }));
  ...
  public EquipmentPanel(UserDto user)
  {
    ...
    try
      {
        business = new BaoFactory().createEquipmnetBao(user);
        EquipmentPanel.user = user;
        viewonly(EquipmentPanel.user);
  ...
  private void initComponents()//GEN-BEGIN:initComponents
  {
    ...
    searchTextField.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    add(searchTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 30, 620, 50));

    EquipmentTable.setAutoCreateRowSorter(true);
    EquipmentTable.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    eqTypeCombo.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    CountryText.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    locationCombo.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    add(no_of_rows, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 880, 190, 30));
    ...
    refreshPanelLayout.setHorizontalGroup(
      ...
      .addComponent(refreshButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
    );
    ...
    try
      {
        ...
        if(!(search.equals("Enter text to search")))
          {
            EquipmentBao equip = new BaoFactory().createEquipmnetBao(user);
            ...
            if(search_list!=null)
              ...
              { // show message when no equipment found then reset and repaint table to default
                JOptionPane.showMessageDialog(null, "Equipmnet Not Found");
    ...
    try
      {
        ...
        eq.setId(Integer.parseInt(EquipmentTable.getModel().getValueAt(row,
          0).toString()));
        ...
        if(business.delete(eq))
          {
            ...
            business.countEquips(new EquipmentTypeDto(EquipmentTable.getModel().getValueAt(row,
                2).toString()));
    ...
    try
      {
        ...
        EquipmentDao e = new DaoFactory().createEquipmentDao(user);
...

  {
    ...
    and repaint the table with the lateset updates */
            if(business.update(eq, user))
              ...
              JOptionPane.showMessageDialog(null, "Equipment does'nt exist",
                "Error", 0);
          }
