...
public class RoleScreenPanel extends javax.swing.JPanel
{
  ...
  public RoleScreenPanel(UserDto userdto)
  {
    ...
    RoleScreenDao dao = new RoleScreenDaoImpl(user); //create LT bao object
  ...
  private void setTableModel(List<RoleScreenDto> types)
  {
    ...
    roleScreenTable.setModel(new javax.swing.table.DefaultTableModel(TypeArr,
        new String[] { "Name Role", "Name Screen", "Full Access",
        "View Only" }));
    ...
    try
      {
        ...
        RoleDao role_dao = new DaoFactory().createRoleDao(user);
        ...
        ScreenDao screen_dao = new DaoFactory().createScreenDao(user);
  ...
  private void initComponents()//GEN-BEGIN:initComponents
  {
    ...
    roleScreenTable.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    RoleComboBox.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    ScreenComboBox.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    RoleSearchCombo.setFont(new java.awt.Font("AGA Cordoba V3 قرطبة", 0, 18)); // NOI18N
    ...
    try
      {
        ...
        RoleScreenBao bao =
          new BaoFactory().createRoleScreenBao(user); //create  bao object
    ...
    defaultdata();
    RoleScreenBao bao = new BaoFactory().createRoleScreenBao(user);
    // view all data again
        ...
        try
          {
            ...
            if(bao.delete(dto))
              ...
              JOptionPane.showMessageDialog(null,
                "This Privilege doesn't exist!", "Error", 0);
    ...
    try
      {
        ...
        RoleScreenDto dto =
          new RoleScreenDto(); //create location type dto object
        RoleScreenBao bao =
          new BaoFactory().createRoleScreenBao(user); //create location type bao object
...

          {
            ...
            if(flag==true)
            ...
            else
              {
                ...
                JOptionPane.showMessageDialog(null,
                  "This privilege does'nt exist exist!", "Invalid Input",
                  1);
            ...
            if(flag==true)
              {
                ...
                //show message tell user that
                JOptionPane.showMessageDialog(null,
                  "Privilege has inserted successfully!", "Done", 1);
